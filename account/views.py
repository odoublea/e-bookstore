...
def wishlist(request):
    ...
    return render(request, "account/dashboard/user_wish_list.html", {"wishlist": books})
...
def add_to_wishlist(request, id):
    ...
    if book.users_wishlist.filter(id=request.user.id).exists():
        ...
        messages.success(request, book.title + " has been removed from your WishList")
    else:
        book.users_wishlist.add(request.user)
        messages.success(request, "Added " + book.title + " to your WishList")
